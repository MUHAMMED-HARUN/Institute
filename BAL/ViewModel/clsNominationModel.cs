...
{
    public class clsNominationModel
    {
        ...
        [HasActiveQuranTestNomination(ErrorMessage ="لديه ترشيح اختبار فعال في هذا اختر فئة اخرى")]
        public int BasicTestID { get; set; }
        [IsQTestDateWithinBaseRange(ErrorMessage ="هذا التاريخ خارج الحدود")]
        ...
        [Display(Name = "الى")]
        [CheckIsPartToGreaterTHANPartFrom(ErrorMessage ="لا يمكن اختيار الاجزاء عكسي")]
